...
@section('content_header')
    <h1 class="m-0 text-dark">Orina Completa</h1>
@stop
                    ...
                    <td>{{ $h->created_at }}</td>
                        <td width="15px">
                            <div class="d-flex">
                                ...
                                <a href="{{route('orina.edit', $h->id) }}" class="btn btn-xs btn-default text-primary mx-1 shadow" title="EDITAR">
                                    <i class="fa fa-lg fa-fw fa-pen"></i>
                                </a>
                                <a href="{{route('orina.show', $h->id) }}" class="btn btn-xs btn-default text-primary mx-1 shadow" title="EDITAR">
                                    <i class="fa fa-lg fa-fw fas fa-eye"></i>
                                </a>
                                <a href="{{route('orina.edit', $h->id) }}" class="btn btn-xs btn-default text-danger mx-1 shadow" title="PDF">
