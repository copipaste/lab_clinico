...
<div class="card">
    <div class="card-body">
        <form action="{{ route('users.store') }}" method="POST">
            ...
            @if(old('role') == 'Paciente' || old('role') == 'Bioquimico' || old('role') == 'Recepcionista')
            <!-- Campos adicionales para el rol de Paciente -->
            <div class="form-group">
            ...
            <!-- Agrega aquí más campos específicos para el rol de Paciente -->
            @endif

            @if(old('role') == 'Paciente')
            <!-- Campos adicionales para el rol de Bioquímico -->
            <div class="form-group">
            ...
            <!-- Agrega aquí más campos específicos para el rol de Bioquímico -->
            @endif

            @if(old('role') == 'Bioquimico' || old('role') == 'Recepcionista')
            <!-- Campos adicionales para el rol de Paciente -->
            <div class="form-group">
