...
<body>
    ...
    <div class="container-fluid text-center">
        <div class="row main-content bg-success text-center">
            <div class="col-md-4 text-center company__info">
                ...
                <h4 class="company_title">Lab Clinic</h4>
            </div>
    ...
    <!-- Footer -->
	<div class="container-fluid text-center footer" style="color: white; text-shadow: 1px 1px 2px black;">&copy; 2024 Lab Clinic. Todos los derechos reservados.</a></p>
	</div>
</body>
